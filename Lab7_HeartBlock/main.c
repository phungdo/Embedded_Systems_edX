...
// write this function
	...
	/*
			...
			do 
			{
				AS = GPIO_PORTF_DATA_R & 0x10; // read status from SW1 again and again
			}while(AS == 0x10); // !AS as long as SW1 is pressed
	*/
}
...
// write this function
	...
	/*
			...
			do
			{
				AS = GPIO_PORTD_DATA_R & 0x10; // read status from SW1 again and again
			}while( AS == ~0x10); // AS as long as SW1 is released
	*/
}
...
void SetVT(void){
// write this function
	GPIO_PORTF_DATA_R |= 0x02; // ^= 0x02 turn red on
}
...
void ClearVT(void){
// write this function
	GPIO_PORTF_DATA_R &= ~0x02; // = 0 turn red off
}
...
void SetReady(void){
// write this function
	GPIO_PORTF_DATA_R |= 0x08; // = 0x08 turn green on
}
...
void ClearReady(void){
// write this function
	GPIO_PORTF_DATA_R &= ~0x08; // = 0 turn green on
}
...
// write this function
    ...
    while (msec > 0) {
        count = 11934;  // 15913 for simulation and 11934 for the real board
        while (count > 0) {
